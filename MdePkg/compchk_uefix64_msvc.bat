...
cl %mdepath%\Library\BaseIoLibIntrinsic\IoLibInternalTdxNull.c /I"%mdepath%" /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /Od /Oi /FAcs /Fa"%objpath%\BaseIoLibIntrinsic\IoLibInternalTdxNull.cod" /Fo"%objpath%\BaseIoLibIntrinsic\IoLibInternalTdxNull.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /FI"Uefi.h" /GS- /Gr /TC /c
