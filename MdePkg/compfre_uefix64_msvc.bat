...
for %%1 in (%mdepath%\Library\BaseLib\*.c) do (cl %%1 /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I"%mdepath%\Test\UnitTest\Include" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\BaseLib\%%~n1.cod" /Fo"%objpath%\BaseLib\%%~n1.obj" /Fd"%objpath%\vc140.pdb" /FI"%mdepath%\Library\BaseLib\BaseLibInternals.h" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c)
...
cl %mdepath%\Library\BaseDebugPrintErrorLevelLib\BaseDebugPrintErrorLevelLib.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\BaseDebugPrintErrorLevelLib\BaseDebugPrintErrorLevelLib.cod" /Fo"%objpath%\BaseDebugPrintErrorLevelLib\BaseDebugPrintErrorLevelLib.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c
...
for %%1 in (%mdepath%\Library\BaseMemoryLib\*.c) do (cl %%1 /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\BaseMemoryLib\%%~n1.cod" /Fo"%objpath%\BaseMemoryLib\%%~n1.obj" /Fd"%objpath%\vc140.pdb" /FI"%mdepath%\Library\BaseMemoryLib\MemLibInternals.h" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c)
lib "%objpath%\BaseMemoryLib\*.obj" /MACHINE:X64 /NOLOGO /OUT:"%binpath%\BaseMemoryLib.Lib"

echo Compiling BasePrintLib...
for %%1 in (%mdepath%\Library\BasePrintLib\*.c) do (cl %%1 /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\BasePrintLib\%%~n1.cod" /Fo"%objpath%\BasePrintLib\%%~n1.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c)
lib "%objpath%\BasePrintLib\*.obj" /MACHINE:X64 /NOLOGO /OUT:"%binpath%\BasePrintLib.Lib"

echo Compiling RegisterFilterLibNull...
cl %mdepath%\Library\RegisterFilterLibNull\RegisterFilterLibNull.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\RegisterFilterLibNull\RegisterFilterLibNull.cod" /Fo"%objpath%\RegisterFilterLibNull\RegisterFilterLibNull.obj" /Fd"%objpath%\vc140.pdb" /FI"%mdepath%\Include\Uefi.h" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c
...
cl %mdepath%\Library\UefiBootServicesTableLib\UefiBootServicesTableLib.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\UefiBootServicesTableLib\UefiBootServicesTableLib.cod" /Fo"%objpath%\UefiBootServicesTableLib\UefiBootServicesTableLib.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c
...
cl %mdepath%\Library\UefiDevicePathLibDevicePathProtocol\UefiDevicePathLib.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\UefiDevicePathLibDevicePathProtocol\UefiDevicePathLib.cod" /Fo"%objpath%\UefiDevicePathLibDevicePathProtocol\UefiDevicePathLib.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c
...
for %%1 in (%mdepath%\Library\UefiLib\*.c) do (cl %%1 /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\UefiLib\%%~n1.cod" /Fo"%objpath%\UefiLib\%%~n1.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c)
lib "%objpath%\UefiLib\*.obj" /MACHINE:X64 /NOLOGO /OUT:"%binpath%\UefiLib.Lib"
 
echo Compiling UefiDebugLibConOut...
for %%1 in (%mdepath%\Library\UefiDebugLibConOut\*.c) do (cl %%1 /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\UefiDebugLibConOut\%%~n1.cod" /Fo"%objpath%\UefiDebugLibConOut\%%~n1.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c)
...
cl %mdepath%\Library\UefiMemoryAllocationLib\MemoryAllocationLib.c /I"%mdepath%\Include" /I"%mdepath%\Include\X64" /I".\\" /Zi /nologo /W3 /WX /O2 /Oi /FAcs /Fa"%objpath%\UefiMemoryAllocationLib\MemoryAllocationLib.cod" /Fo"%objpath%\UefiMemoryAllocationLib\MemoryAllocationLib.obj" /Fd"%objpath%\vc140.pdb" /FI"pcdhack.h" /GS- /Gr /TC /c
